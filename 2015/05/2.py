...
while True:
    ...
    #
    # Also hate the language for fucking trying to reinvent standards, "([.])" does not work but "(.)" does. Makes no sense just like the language itself
    if (re.search(r"(.).\1", line) != None) and (
        re.search(r"(.{2}).*?\1", line) != None
    ):
        nice_count += 1
